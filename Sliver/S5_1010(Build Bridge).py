...
# Pre_Processing( Init Factorial String ) 
Factorial_String=[ 1, 1, 2]
for _ in range( 3, 30 ): Factorial_String.append( Factorial_String[ _ - 1 ] * _ ) 


# Inputed Number
for _ in range( int( input() ) ):
               
    Number_N, Number_M = map(int, input().split())
    print( Factorial_String[ Number_M ] // ( Factorial_String[ Number_N ] * Factorial_String[ Number_M - Number_N ] ) )
